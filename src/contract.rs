...
/*
const CONTRACT_NAME: &str = "crates.io:cw-721-base-starter";
...
mod tests {
    ...
    use cosmwasm_std::{from_binary, to_binary, CosmosMsg, WasmMsg, DepsMut, Empty, Response};
    use cw721::{
      Cw721Query, Approval, ApprovalResponse, ContractInfoResponse, Cw721ReceiveMsg, Expiration,
